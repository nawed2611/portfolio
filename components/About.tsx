  ...
  return (
    <div className="flex flex-col mx-auto items-start justify-center max-w-5xl">
      <div className="flex gap-3 w-full flex-col p-2 md:flex-row">
        <AboutCards
          title="Computer Science & Engineering student exploring the worlds of Web3.0 and Open-Source. Participated in over 25 Hackathons as a hacker, mentor and as an organiser."
        ...
        />
        <AboutCards
          title="Experienced with TypeScript based technologies like React.js, ReactNative.js, Node.js, Express.js, Next.js also worked with C/C++, Python, PHP, Rust, Julia and Java."
